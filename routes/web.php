...
//Category Routes
Route::post('/addCategory', 'CategoryController@addCategory'); // add category
Route::get('/allCat', 'CategoryController@showAllCategory'); // show All category
Route::Delete('/delCat', 'CategoryController@delCategory'); // delete category
Route::get('/editCat', 'CategoryController@editCategory'); // edit category
Route::get('/allCat', 'CategoryController@showAllCategory'); // show  category for edit
Route::get('/allCat', 'CategoryController@changeCatStatus'); // change status category 
