...
Route::Delete('delCat/{id}', 'CategoryController@delCategory'); // delete category    // done
Route::get('/editCat', 'CategoryController@editCategory'); // edit category          // done
Route::get('/catEdit{id}edit', 'CategoryController@showCatEdit')->name('cat.edit'); // show  category for edit
